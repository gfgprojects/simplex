...
public class RDim extends Object{
    int myDim;
    RDim dimension;
    BigDecimal passo=new BigDecimal(MainWindow.passo);
	...
	if(myDim<MainWindow.dimension){
	    dimension=new RDim(myDim);
	}
    }
	...
	case 1: istruzioniPerPrimo(vet);
	    break;
	case MainWindow.dimension: istruzioniPerUltimo(vet);
	    break;
	...
	*/
	...
	if(tot.compareTo(new BigDecimal("1"))<0){
	    ...
	    for(int i=myDim-1;i<MainWindow.dimension;i++){
		vet[i]=new BigDecimal("0.0");
	    }
	    //	    System.out.print(vet[0]);
	    MainWindow.out.print(vet[0]);
	    for(int i=1;i<vet.length;i++){
		//	    	    System.out.print(";"+vet[i]);
		MainWindow.out.print(";"+vet[i]);
	    }
	    //	    System.out.println();
	    MainWindow.out.println();
	}
    }
